...
DEFINE_PER_CPU(unsigned long int, activate_safe_mode) = 0;
EXPORT_PER_CPU_SYMBOL(activate_safe_mode);


DEFINE_PER_CPU(unsigned long int, Vf_APP_index);
DEFINE_PER_CPU(unsigned long int, delta_SI) ;  //in principle : scheduling tick;
DEFINE_PER_CPU(unsigned long int, t_LI) ;
DEFINE_PER_CPU(unsigned long int, V_LI) ;
DEFINE_PER_CPU(unsigned long int, delta_LI) ;
DEFINE_PER_CPU(unsigned long int, V_LTC);
DEFINE_PER_CPU(unsigned long int, V_STC);
DEFINE_PER_CPU(unsigned long int, V_APP);
DEFINE_PER_CPU(unsigned long int, f_APP);
DEFINE_PER_CPU(unsigned int, HL_flag);
DEFINE_PER_CPU(unsigned int, pid_gov);


DEFINE_PER_CPU(unsigned int, reliability_gov_ready) = 0;
...
long reliability_update_stats(unsigned int pid_sched , int cpu);
...
// PIETRO : this function is for reading cycles
...
void scheduler_tick(void)
{
	...
	// PIETRO
	#ifdef CONFIG_RELIABILITY
	__get_cpu_var(pid_gov) = curr -> pid;

	//call the function that writes data on the buffer
	#ifdef READ_RELIABILITY_STATS 

	reliability_update_stats(curr -> pid , cpu);
